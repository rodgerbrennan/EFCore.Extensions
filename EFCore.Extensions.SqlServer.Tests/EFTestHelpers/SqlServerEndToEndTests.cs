...
namespace Microsoft.EntityFrameworkCore
{
    public class SqlServerEndToEndTest : IClassFixture<SqlServerFixture>
    {
        ...
        public class NumNumContext : DbContext
        {
        ...
        public void AssertEqual(VariableDataTypes expected, VariableDataTypes actual)
        {
        ...
        public async Task RoundTripChanges<TBlog>() where TBlog : class, IBlog, new()
        {
            using (var testDatabase = SqlServerTestStore.Create(DatabaseName))
            {
                var optionsBuilder = new DbContextOptionsBuilder()
        ...
        public static async Task<TBlog[]> CreateBlogDatabaseAsync<TBlog>(DbContext context) where TBlog : class, IBlog, new()
        {
            context.Database.EnsureCreated();
        ...
        public const string DatabaseName = "SqlServerEndToEndTest";

        public readonly SqlServerFixture _fixture;
        ...
        public class BloggingContext : BloggingContext<Blog>
        {
        ...
        public class BloggingContext<TBlog> : DbContext
        ...
        public class ChangedChangingBlog : INotifyPropertyChanging, INotifyPropertyChanged, IBlog
        {
            public int _id;
            public string _name;
            public bool _george;
            public Guid _theGu;
            public DateTime _notFigTime;
            public byte _toEat;
            //public char _cupOfChar;
            public double _orNothing;
            public short _fuse;
            public long _wayRound;
            //public sbyte _notToEat;
            public float _away;
            //public ushort _orULong;
            //public uint _orUSkint;
            //public ulong _orUShort;
            public byte[] _andChew;
            ...
            public void NotifyChanging([CallerMemberName] string propertyName = "")
                => PropertyChanging?.Invoke(this, new PropertyChangingEventArgs(propertyName));
        }

        public class ChangedOnlyBlog : INotifyPropertyChanged, IBlog
        {
            public int _id;
            public string _name;
            public bool _george;
